...
%\documentclass[glossnowarn]{texjazz-handbook}% Final output
%\documentclass[showframe]{texjazz-handbook}% Controlling the layout output
...
%\documentclass[english,licence]{texjazz-handbook}% English document (if needed: not here)
%\documentclass[showframe]{texjazz-handbook}
%\documentclass[showframe]{texjazz-handbook}
%\documentclass[printfiles, showframe]{texjazz-handbook}% COMPILATION ERROR! WHY? FIX ME!
\documentclass[assignpoints,askreply]{texjazz-handbook}
...
%--------------------------------------------------------------------------------------------------
%---- Note about TeXLive 2020 "autumn" (winter leads to OLDFASHION!!! 2020-12-19, see sources)
%- Since the new version of `menukeys` (2020-12-19) all is fine :-) The package does not load 
%- anymore the `catoptions` package (really good solution! Its author Ahmed Musa seems to have
%- "pris le chou" as we say in French! − see all his posts and comments on TeX.SX)
%---- NO MORE NEEDED!!! (for the record)
%- After an update of TeXLive 2020 around the first of October, the `menukeys` package breaks
%- the compilation flow. The reason comes from the use of `catoptions` package, which redefines
%- a lot of LaTeX code and does not work at all in the current release (see David Carlisle
%- answer to our question: https://tex.stackexchange.com/questions/565937/). The author of
% `menukey` has been informed (see GitHub) but has no time to solve the issue. Nevertheless,
%- a workaround is to update TeXlive distribution and then downgrade to the previous LaTeX kernel
%- with TeXLive manager: 
%-   $ tlmgr restore latex
...
%inria-mooc-chapter00-writing-guide,% Guide de rédaction (seulement en version complète)
...
%inria-mooc-chapter15,% Programmation orientée objet (semaine 6)
